      ...
      <div className="container mx-auto px-4 lg:px-6">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-accent font-bold text-foreground mb-6">
            Trusted by <span className="text-accent">100+ Turkish Businesses</span>
          </h2>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => (
            <Card 
              key={index} 
              className="p-6 text-center hover:shadow-glow transition-all duration-300 hover:scale-105 animate-fade-in bg-card border-border shadow-card"
            ...
            >
              <div className="flex flex-col items-center space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted font-body leading-tight">
                    {stat.description}
                  </p>
                </div>
              </div>
        ...
        <div className="mt-16 text-center">
          <blockquote className="text-2xl font-accent font-light text-muted italic max-w-4xl mx-auto">
          ...
          <div className="mt-6 flex items-center justify-center space-x-4">
            ...
            <div className="text-left">
              ...
              <div className="text-muted text-sm font-body">Istanbul, Turkey</div>
            </div>
          </div>
        </div>
      </div>
